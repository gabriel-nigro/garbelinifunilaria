    ...
    <div className="container" id="home">
      <div className="row">
        <div className="col-md-12 col-lg-7">
          <p className="fs-0 fw-bold zindex">Melhor escolha em Funilaria e Pintura</p>
          <p className="fs-5-5 pb-4-5 m-0 zindex">Oferecemos o melhor serviço a você, com profissionais experientes e competentes. Somos a opção ideal para garantir a boa condição de funilaria e pintura do seu veículo.</p>
