    ...
    <div className="container" id="about-us">
      <div className="row">
        ...
        <div className="col-sm-12 col-lg-6 d-flex flex-column justify-content-center">
          ...
          <p className="carRepair-title fw-bold">
            We Make Your Car Comfortable
          </p>
          <p className="fs-6-car-repair">
            CarRepair is one of the workshops that can serve home service calls.
            All mechanics at CarRepair already have a long experience, so high
            quality mechanics to solve all your car problems.
          </p>
        </div>
      </div>
    </div>
